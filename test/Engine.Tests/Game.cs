...
namespace Engine.Tests
{
    public class GameTests
    {
        ...
        {
            // Assemble
            var player1 = new Player(new PlayerConstructorArguments { BoardSize = 11, PlayerNumber = PlayerNumber.FirstPlayer });
            var player2 = new Player(new PlayerConstructorArguments { BoardSize = 11, PlayerNumber = PlayerNumber.SecondPlayer });
